...
const OrderDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (orderData) {
      ...
      router.push('/order-form'); // Redirect jika tidak ada data
    }
  }, [router]);
          ...
          <div className="col-lg-8">
            ...
            <div className="card shadow border-0">
              ...
              <div className="card-body p-4">
                {/* Status */}
                <div className="alert d-flex align-items-center mb-4" style={{
                  ...
                  <div>
                    ...
                    <p className="mb-0 small" style={{color: '#be185d'}}>Dibuat pada: {currentOrder.createdAt}</p>
                  </div>
                </div>
                    ...
                    <div className="card-body d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <span className="fw-semibold">
                          {currentOrder.serviceType === 'male' ? 'Petugas Laki-laki' : 'Petugas Perempuan'}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card mb-3" style={{
                    ...
                    <div className="card-body d-flex align-items-start">
                      ...
                      <div className="flex-grow-1">
                        ...
                        <span className="fw-semibold" style={{whiteSpace: 'pre-line'}}>{currentOrder.address}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="alert" style={{
                  ...
                  <div className="d-flex align-items-start">
                    ...
                    <div>
                      ...
                      <small>
                        Tim kami akan menghubungi Anda melalui WhatsApp dalam waktu maksimal 1 jam untuk konfirmasi lebih lanjut.
                      </small>
                    </div>
                  </div>
                </div>
